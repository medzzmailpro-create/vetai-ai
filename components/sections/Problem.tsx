      ...
      <div style={{ maxWidth: 1160, margin: '0 auto' }}>
        ...
        <div className="fade-up" style={{ background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', borderRadius: 12, overflow: 'hidden' }}>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr' }}>
            <div style={{ padding: '16px 28px', fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', background: 'rgba(229,62,62,0.15)', color: '#E53E3E' }}>❌ Sans Vetai</div>
            <div style={{ padding: '16px 28px', fontFamily: 'Syne, sans-serif', fontSize: 14, fontWeight: 700, letterSpacing: '0.06em', textTransform: 'uppercase', background: 'rgba(56,161,105,0.15)', color: '#38A169' }}>✅ Avec Vetai</div>
          </div>
        ...
        <div className="fade-up" style={{ marginTop: 40, padding: '28px 36px', background: 'rgba(245,166,35,0.1)', border: '1px solid rgba(245,166,35,0.2)', borderRadius: 12, textAlign: 'center' }}>
          <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: 16, lineHeight: 1.7 }}>
            <strong style={{ color: '#F5A623' }}>Vetai change ça.</strong> 6 agents IA travaillent pour vous 24h/24 et libèrent votre équipe pour ce qui compte vraiment : les animaux.
          </p>
        </div>
      </div>
    </section>
